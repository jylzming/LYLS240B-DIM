...
3277                     ; 10 	for(i=0; i<1024; i++)
3279  0002 5f            	clrw	x
3280  0003 1f01          	ldw	(OFST-3,sp),x
3281  0005               L3222:
3282                     ; 12 		for(j=0; j<512; j++); 
3284  0005 5f            	clrw	x
